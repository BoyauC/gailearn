...
- 課堂建立 24 小時後自動關閉並停止新學生加入；已加入者可在到期後 10 分鐘內補交。
- 教師後台即時顯示加入數、checkpoint、完成人數、平均分數、個別進度與題目首答正確率，並可下載 CSV。
- 課堂與作答資料保留 30 天，再由每日排程一般刪除；未使用 Firestore TTL。
...
- Functions 整合測試涵蓋完整課堂生命週期、匿名編號、checkpoint、重複提交、改密碼、關閉／補交、代碼唯一性、5 次登入鎖定與 30 天清理。
